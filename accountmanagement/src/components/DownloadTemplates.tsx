...
const DownloadTemplates: React.FC<DownloadTemplatesProps> = ({
  ...
  const TEMPLATE_COMPONENTS: Record<string, React.ElementType> = {
    ...
    "Account Cockpit View": AccountCockpitView,
    ...
    "Customer & Version 1": CustomerProfile,
    "Tech spend breakdown by client BU and Geography": TechSpendView,
    "Growth Strategy": GrowthStrategy,
    "Service Line Growth Actions": ServiceLineGrowth,
    "Org structure: Tech view": OrgStructureTechView,
    "Relationship Heatmap": RelationshipHeatmap,
    "Revenue Teardown: EE vs. EN  & Geo teardown": RevenueTeardownView,
    "Revenue teardown: Service Line Penetration": ServiceLinePenetration,
    "Summary of key growth opportunities in the account": GrowthOpportunitiesPage,
    "Deep dive: OPPORTUNITY NAME": OpportunityDeepDive,
    "Implementation plan for growth": ImplementationPlanPage,
    "Innovation excellence overview: Our understanding of client’s AI strategy": InnovationStrategy,
    "Planned action for next 12 months: GenAI": PlannedActionGenAI,
    "Strategic Partnerships": StrategicPartnershipsPage,
    "Operational Excellence Strategy": OperationalExcellencePage,
    "Margin Improvement Plan 1": MarginImprovementPlan,
    "Margin Improvement Plan 2": MarginImprovementPlan2,
    "Critical Risk Tracking": CriticalRiskPage,
    "Talent excellence overview": TalentExcellenceOverview,
    "Implementation plan for operational excellence, delivery, and talent": OperationalImplementationPlan,
    "Investment plan for next 12 months": InvestmentPlan,
  };
